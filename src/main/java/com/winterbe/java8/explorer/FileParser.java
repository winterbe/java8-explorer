...
public class FileParser {
    ...
    public Optional<TypeInfo> parse(File file, int id) throws IOException {
        if (!file.exists()) {
        ...
        try {
            return getTypeInfo(document, id);
        }
        catch (Exception e) {
    ...
    private Optional<TypeInfo> getTypeInfo(Document document, int id) {
